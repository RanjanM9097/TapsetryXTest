...
@Entity
@Table(name = "del_contra_transaction")
public class ContraTransactionDelDetails {
	@Id
...
//	}
	...
	public String toString() {
		return "ContraTransactionDelDetails [contraid=" + contraid + ", nodeid=" + nodeid + ", tx_id=" + tx_id
				+ ", extTxnId=" + extTxnId + ", assetid=" + assetid + ", Asset_name=" + Asset_name + ", FDPeriodId="
				+ FDPeriodId + ", airlocknode=" + airlocknode + ", tranperiodfk=" + tranperiodfk + ", trandt=" + trandt
				+ ", postperiodfk=" + postperiodfk + ", flid=" + flid + ", fladdrid=" + fladdrid + ", postdt=" + postdt
				+ ", fladdridparentfk=" + fladdridparentfk + ", trhash=" + trhash + ", tranqty=" + tranqty + ", qtyALR="
				+ qtyALR + ", txDel=" + txDel + ", txREC=" + txREC + ", nDel=" + nDel + ", nREC=" + nREC
				+ ", contingentId=" + contingentId + ", shortTransferId=" + shortTransferId + ", contraType="
				+ contraType + ", encryptedhash=" + encryptedhash + ", digitalsig=" + Arrays.toString(digitalsig)
				+ ", assetLotId=" + assetLotId + ", assetLotNetId=" + assetLotNetId + ", assetLotReceiverId="
				+ assetLotReceiverId + ", contramatchStatus=" + contramatchStatus + ", useCase=" + useCase + ", TxType="
				+ TxType + ", getAirlocknode()=" + getAirlocknode() + ", getExtTxnId()=" + getExtTxnId()
				+ ", getAsset_name()=" + getAsset_name() + ", getContraid()=" + getContraid() + ", getNodeid()="
				+ getNodeid() + ", getAssetid()=" + getAssetid() + ", getTranperiodfk()=" + getTranperiodfk()
				+ ", getTrandt()=" + getTrandt() + ", getPostperiodfk()=" + getPostperiodfk() + ", getFlid()="
				+ getFlid() + ", getFladdrid()=" + getFladdrid() + ", getPostdt()=" + getPostdt()
				+ ", getFladdridparentfk()=" + getFladdridparentfk() + ", getTrhash()=" + getTrhash()
				+ ", getTranqty()=" + getTranqty() + ", getEncryptedhash()=" + getEncryptedhash() + ", getDigitalsig()="
				+ Arrays.toString(getDigitalsig()) + ", getAssetLotId()=" + getAssetLotId() + ", getAssetLotNetId()="
				+ getAssetLotNetId() + ", getAssetLotReceiverId()=" + getAssetLotReceiverId() + ", getTx_id()="
				+ getTx_id() + ", isContramatchStatus()=" + isContramatchStatus() + ", getQtyALR()=" + getQtyALR()
				+ ", getTxDel()=" + getTxDel() + ", getTxREC()=" + getTxREC() + ", getContingentId()="
				+ getContingentId() + ", getShortTransferId()=" + getShortTransferId() + ", getContraType()="
				+ getContraType() + ", getnDel()=" + getnDel() + ", getnREC()=" + getnREC() + ", getUseCase()="
				+ getUseCase() + ", getTxType()=" + getTxType() + ", getFDPeriodId()=" + getFDPeriodId()
